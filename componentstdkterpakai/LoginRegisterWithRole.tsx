...
import { Eye, EyeOff, Smartphone, Mail, User, Lock, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center justify-center w-50 h-50 rounded-full">
          <img src="src/assets/logo.svg" alt="EcoScope" style={{ width: '150px', height: '150px', objectFit: 'contain' }} />
        </div>
          <h1 className="text-3xl font-bold text-gray-900 mb-2">EcoScope Banyumas</h1>
          <p className="text-gray-600">Platform monitoring lingkungan dan pasar pertanian</p>
        </div>
              ...
              <TabsContent value="login" className="space-y-4">
                ...
                <form onSubmit={handleLogin} className="space-y-4">
                  ...
                  <Button type="submit" className="w-full">
                    Masuk ke Dashboard
                    {selectedRole === 'admin' && <Badge variant="destructive" className="ml-2">Admin</Badge>}
                  </Button>
                </form>
        ...
        <div className="text-center mt-8 text-sm text-gray-500">
          ...
          <p className="mt-1">Versi 1.0.0 | Kontak: info@ecoscope-banyumas.id</p>
        </div>
      </div>
    </div>
  );
