  ...
  const loadPrices = async () => {
    ...
    try {
      ...
      if (result.success && result.data) {
        ...
        toast.error("Gagal memuat data harga: " + (result.error || "Unknown error"));
      }
    } catch (error) {
      ...
      {loading && prices.length === 0 ? (
        ...
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <p className="text-muted-foreground">Tidak ada data harga tersedia</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {commodities.map((commodity) => {
            ...
            return (
              <Card key={commodity} className="hover:shadow-lg transition-shadow">
                <CardHeader>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm">
                      <div>
                        ...
                        <p className="font-medium">{latestPrice.market_location}</p>
                      </div>
                    ...
                    <div className="pt-2 border-t">
                      <p className="text-xs text-muted-foreground">
                        Tanggal: {new Date(latestPrice.date).toLocaleDateString("id-ID")}
                      </p>
                      <p className="text-xs text-muted-foreground">
