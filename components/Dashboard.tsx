...
import { Mountain, Cloud, TrendingUp, AlertTriangle, Sun, CloudRain } from "lucide-react";
...
export function Dashboard({ onNavigate, onLogout }: DashboardProps) {
  ...
  // Fungsi untuk mengubah role lokal dashboard (hanya visual, tidak global)
    ...
    <div className="p-6 max-w-8xl mx-auto">
      <div className="mb-6 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2">
          ...
          <span className="text-sm font-medium">{userRole === "admin" ? "Admin" : "User"}</span>

          {/* Role dropdown menu */}
          <Menu as="div" className="relative inline-block text-left">
            <div>
              <MenuButton className="flex items-center space-x-1 p-2 text-sm text-gray-700 bg-gray-200 rounded-md hover:bg-gray-300 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
            ...
            >
              <MenuItems className="absolute right-0 mt-2 w-32 origin-top-right divide-y divide-gray-100 rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none z-10">
                <div className="py-1">
                  {/* Menu item for Admin */}
                              <MenuItem>
              {({ active }) => (
