...
export default function App() {
  ...
  const [appMode, setAppMode] = useState<"landing" | "public" | "admin">(
    "public"
  );
  ...
  const handlePageChange = (page: string) => {
    ...
    if (
      ["dashboard", "weather", "price-prediction", "slope-analysis"].includes(
        page
      )
    ) {
      setAppMode("public");
  ...
  const NavigationComponent =
    isLoggedIn && appMode === "admin" ? AdminNavigation : PublicNavigation;
